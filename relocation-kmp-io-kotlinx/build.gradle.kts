...
mavenPublishing {
    ...
    coordinates("no.synth", "kmp-io-kotlinx", version.toString())

    pom {
        name.set("kmp-io-kotlinx (relocated to no.synth:kmp-zip-kotlinx)")
        description.set("This artifact has been relocated to no.synth:kmp-zip-kotlinx")
        ...
        withXml {
            asNode().appendNode("distributionManagement").apply {
                appendNode("relocation").apply {
                    ...
                    appendNode("artifactId", "kmp-zip-kotlinx")
                    appendNode("message", "This artifact has moved to no.synth:kmp-zip-kotlinx")
                }
            }
        }
    }
